...
const HamburgerMenu = () => {
	...
	return (
		<div ref={menuRef} className={`menu-container ${isOpen ? 'open' : ''} m-auto relative z-50`}>
			<button
				ref={buttonRef}
				className="px-4 py-2 shadow m-auto rounded-full border-gray-200"
				onClick={toggleMenu}>
				<img src="/hamburger.svg" alt="Hamburger Icon" width="24" height="24" className="w-full" />
			</button>
			<nav
				className={`menu ${
					isOpen ? 'open' : ''
					...
					<li className="flex flex-col gap-4">
						<a href="/pdf">
							<span>
								...
								<p className={`text-m font-bold text-gray-200 ${sourceCodePro.className}`}>PDF-GPT</p>
							</span>
						</a>
					</li>
					<li className="flex flex-col gap-4">
						<a href="/memory">
							<span>
								...
								<p className={`text-m font-bold text-gray-200 ${sourceCodePro.className}`}>Memory</p>
							</span>
						</a>
					</li>
					<li className="flex flex-col gap-4">
						<a href="streaming">
							<span>
								...
								<p className={`text-m font-bold text-gray-200 ${sourceCodePro.className}`}>Streaming</p>
							</span>
						</a>
					</li>
					<li className="flex flex-col gap-4">
